package com.pivinadanangbe.controller.admin;
...
import com.pivinadanangbe.services.impl.MapValidationErrorService;
...
@RestController
@CrossOrigin
@RequestMapping(value = "/api/version1/manufacturers")
